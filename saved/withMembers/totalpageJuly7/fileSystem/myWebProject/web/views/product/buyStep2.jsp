...
<script>
		$(function(){
			...
			$("#pay").click(function(){
				...
				window.open("/mwp/views/product/buyPage.jsp?totalPrice=<%=totalPrice+list.size()*2500%>&pnames=<%=names%>&prices=<%=prices%>&counts=<%=counts%>&pnos=<%=pno%>&cnos=<%=cno%>","_black","width=390, height=500, left=200, top=200");
			});
		});
