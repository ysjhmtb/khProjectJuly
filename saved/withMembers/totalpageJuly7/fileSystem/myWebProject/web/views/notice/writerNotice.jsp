...
<div id="topBar">
<div align="center" style="font-size:25px; margin-bottom:23px;">공지사항 등록</div>
</div> 
<div align="center">
<form id="proInfo" method="post" action="/mwp/noticeWriter.do" enctype="multipart/form-data">
