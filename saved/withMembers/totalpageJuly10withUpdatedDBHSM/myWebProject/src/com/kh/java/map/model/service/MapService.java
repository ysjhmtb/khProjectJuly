...
public class MapService {
	...
	public ArrayList<MapVo> selectCalendar() {
		Connection con = JDBCTemplate.getConnection();
		ArrayList<MapVo> list = new MapDao().selectCalendar(con);
		JDBCTemplate.close(con);
		return list;
	}
	...
	public ArrayList<MapVo> selectIndexMarketList() {
		Connection con = JDBCTemplate.getConnection();
		ArrayList<MapVo> list = new MapDao().selectIndexMarketList(con);
		JDBCTemplate.close(con);
		return list;
	}
