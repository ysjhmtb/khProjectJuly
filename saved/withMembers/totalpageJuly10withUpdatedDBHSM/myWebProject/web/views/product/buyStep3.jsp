...
<%
	...
	int totalPrice = 0;
	String[] infoStr = request.getParameter("infoStr").split(", ");
		...
		<tr class="line">
			<td class="left">
				<dl class="order_thumb_wrap">
					<dt>
						<img src="/mwp/<%=new ProductService().selectProduct(bv.getPno()).getImg_src() %>" class="order_thumb" onerror="this.src='/mwp/views/common1Page/data/skin/fruit_puro_gls/images/common/noimage_list.gif'" alt="" />
					</dt>
					<dd>
...
<div class="order_settle view clearbox">
	...
	<div class="info_right bgcolor">
		...
		<ul class="item clearbox">
			<li><%=infoStr[0]%></li>
			<li><%=infoStr[4]%>-<%=infoStr[5]%>-<%=infoStr[6]%></li>
			<li><%=infoStr[7]%></li>
			<li class="pdt5"></li>
...
<div class="order_settle view clearbox">
	...
	<div class="benefit">
		...
		<dl class="clearbox">
			...
			<dt>결제금액</dt>
			<dd><strong><%=totalPrice %>원</strong></dd>
		</dl>
	</div>
	<!-- 주문결제 정보 :: END -->
	...
	<div class="settle bgcolor">
		<dl class="clearbox">
			...
			<dd class="total " style="width:70%">
				<span class="price tahoma"><%=totalPrice %>원</span>
...
<div class="btn_wrap">
	<a href="/mwp/indexMarket.jsp" class="btn_move large">쇼핑 계속하기</a>
	<a href="/mwp/views/member/mypage.jsp" class="btn_chg large">MY페이지 주문내역</a>
</div>
<!-- //버튼 -->
<!-- //본문내용 끝 -->
