...
if(reportNext ==null && reportPre == null){
	msgNext = "다음 글이 없습니다.";
	msgPre = "이전 게시글이 없습니다.";
}else if(reportNext ==null){
 	msgNext = "다음 글이 없습니다.";
...
<!-- 본문내용 시작 -->
		...
		<table class="bbsview_table_style" width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tbody>
				<tr>
					...
					<td class="name"><%=report.getName() %></td>
	...
	<ul class="bbsbtn_wrap4">
		...
		<%
		if(member !=null && member.getM_NAME().equals(report.getName()) || member.getM_NAME().equals("관리자")){ %>
