...
/* 		padding-left:23%; */
		...
		background-image: url("/mwp/upload/indexImage/countdowmimage.jpg");
		opacity:0.8;
	...
	#map{
		height:40%;
		background-image: url("/mwp/upload/indexImage/mapbtn.jpg");
		background-size: cover;
		cursor: pointer;
		font-size: 55px;
...
<div class='designBanner' designElement='banner' templatePath='main/index.html' bannerSeq='1' style='height:568px;'><img src="/mwp/upload/indexImage/banner1.jpg" width="100%" height="568" /></div>
...
<script>
		$(function(){
			...
			var settings1= {
				...
				'images' : 
					[{'image':'/mwp/upload/indexImage/banner1.jpg'},
						{'image':'/mwp/upload/indexImage/image_2.jpg'}],
