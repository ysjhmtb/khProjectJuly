...
public class SelectSearchNotice extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public SelectSearchNotice() {
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = ns.searchNoticeCount(keyword);
		...
		ArrayList<NoticeVo> list = ns.selectSearchNoticeList(currentPage,limit,keyword);
