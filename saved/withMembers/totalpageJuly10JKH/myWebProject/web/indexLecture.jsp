	...
	<thead>
      <tr>
         ...
         <th width=80px;;></th>
            ...
            <th width=10%;><button class="btn_sch" style="font-size:14px; background:#232833; border:none;" id="lectureBtn" onMouseOver="this.style.color='#585858'" onMouseOut="this.style.color='white'">강의 등록</button></th>
            <%}else{ %>
            <th width=80px;></th>
            <%} %>
            <%} %>
