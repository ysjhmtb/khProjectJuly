<%@page import="com.kh.java.product.model.vo.CartVo"%>
...
<script>
		$(function(){
			...
			$("#pay").click(function(){
				var mname = $("#recipient_user_name").val();
				var address1 = $("#recipient_address_street").val();
				var address2 = $("#recipient_address_detail").val();
				var postcode = $("#international_postcode").val();
				var phone1 = $("#phone1").val();
				var phone2 = $("#phone2").val();
				var phone3 = $("#phone3").val();
				var email = $("#recipient_email").val();
				var infoStr = mname+", "+address1+", "+address2+", "+postcode+", "+phone1+", "+phone2+", "+phone3+", "+email;
				<% String names="";%>
				<% String prices="";%>
				<% String counts="";%>
				<% String pno="";%>
				...
				window.open("/mwp/views/product/buyPage.jsp?totalPrice=<%=totalPrice%>&pnames=<%=names%>&prices=<%=prices%>&counts=<%=counts%>&pnos=<%=pno%>&cnos=<%=cno%>&infoStr="+infoStr,"_black","width=390, height=500, left=200, top=200");
			});
		});
		...
		<tr class="goods_1_1_delivery">
			<td class="left">
				...
				<dl class="order_thumb_wrap">
					<dt>
						<img src="<%=cv.getPv().getImg_src() %>" class="order_thumb" onerror="this.src='/mwp/views/common1Page/data/skin/fruit_puro_gls/images/common/noimage_list.gif'" alt="다양한 배송방법 지원" />
					</dt>
					<dd>
...
<div class="order_settle clearbox line">
	...
	<div class="settle bgcolor line">
		<dl class="clearbox">
			...
			<dd class="goods_delivery_info"><span class="normal">(+)</span> <span class="total_delivery_shipping_price">0</span>원</dd>
			<dt>
				할인금액
...
<div class="pdt30 pay_layer center">
	<button type="button" class="btn_move large" onclick="location='/mwp/views/product/cart.jsp'">장바구니로 돌아가기</button>
...
<div style="display:none;" class="pay_layer center">
	<div class="hide"><img src="/mwp/views/common1Page/data/skin/fruit_puro_gls/images/design/img_paying.gif" alt="" /></div>
	<div class="pdt20"><img src="/mwp/views/common1Page/data/skin/fruit_puro_gls/images/design/progress_bar.gif" alt="" /></div>
</div>
</form>
...
<!-- SCRIPT :: START -->
<script type="text/javascript" src="/mwp/views/common1Page/app/javascript/jquery/jquery.form.js" charset="utf8"></script>
...
<script type="text/javascript" src="/mwp/views/common1Page/app/javascript/js/order-settle.js?dummy=20180703160358" charset="utf8"></script>
<script type="text/javascript" src="/mwp/views/common1Page/app/javascript/js/skin-order-settle.js" charset="utf8"></script>
<!-- SCRIPT :: END -->
