...
<script>
	...
	function updateCount(uCount){
		...
		location.href="/mwp/updateCartCount.do?cno="+cno+"&count="+count;
	}
	
	function deleteCart(cno){
	      location.href="/mwp/deleteC.do?cno="+cno;
	   }
	
	$(function(){
//	 	전체주문버튼
		$("#allBuyBtn").click(function(){
			location.href="/mwp/buyProd.do?mno=<%=mno%>";
		});
...
//	 	선택주문버튼
	...
	<div id="layout_config">
		<div id="layout_config_full"><script type='text/javascript'>var fbv='2.6';</script><script type='text/javascript' src='/mwp/views/common1Page/app/javascript/js/facebook.js?v=20150501' charset='utf8'></script>
		...
		<tr>
			...
			<td class="relative line">
				<dl class="order_thumb_wrap">
					<dt>
						<a href="#"><img src="/mwp/<%=cv.getPv().getImg_src() %>" class="order_thumb" onerror="this.src='/mwp/views/common1Page/data/skin/fruit_puro_gls/images/common/noimage_list.gif'" alt="쇼핑몰 쉽게 꾸밀수 있어요" /></a>
					</dt>
					<dd>
					...
					<tr>
						...
						<td>
							...
							<div class="order_change">
								<button type="button" class="btn_shipping_modify btn_chg small" cart_seq="77" prepay_info="delivery" nation="korea" goods_seq="17" hop_date="" reserve_txt="" onclick="deleteCart(<%=cv.getCno()%>)">삭제</button>
							</div>
							<!-- 배송방법 변경 :: END -->
						</td>
					</tr>
...
<div class="btn_wrap">
	<button type="button" class="btn_move large" onclick="location='/mwp/indexMarket.jsp'">계속 쇼핑하기</button>
