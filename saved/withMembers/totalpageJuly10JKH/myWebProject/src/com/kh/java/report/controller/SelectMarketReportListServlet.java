...
@WebServlet("/marketReportList.do")
public class SelectMarketReportListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SelectMarketReportListServlet() {
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = rs.selectReportCount();
