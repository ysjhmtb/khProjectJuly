...
/**
 * Servlet implementation class CkeditorImageUpload
 */
@WebServlet("/ckeditorImageUpload.do")
public class CkeditorImageUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CkeditorImageUpload() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String uploadUrl= "http://localhost:8081/nycProject/"+fileSavePath;
